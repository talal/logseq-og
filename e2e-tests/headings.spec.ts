...
test('set heading to 1', async ({ page }) => {
  ...
  await page
    .locator('span.bullet-container >> nth=0')
    .click({ button: 'right' })

  await page
    .locator('#custom-context-menu .to-heading-button[title="Heading 1"]')
    .click()
  ...
  expect(
    await page.locator('.ls-block .block-content >> nth=0').innerHTML()
  ).toContain('<h1>foo</h1>')
})
...
test('remove heading', async ({ page }) => {
  ...
  await page
    .locator('#custom-context-menu .to-heading-button[title="Remove heading"]')
    .click()
...
test('set heading to 2', async ({ page }) => {
  await page
    ...
    .click({ button: 'right' })
  await page
    .locator('#custom-context-menu .to-heading-button[title="Heading 2"]')
    .click({ delay: 400 })
...
test('switch to auto heading', async ({ page }) => {
  ...
  await page
    .locator('#custom-context-menu .to-heading-button[title="Auto heading"]')
    .click()
...
test('set heading of nested block to auto', async ({ page }) => {
  ...
  await page
    .locator('span.bullet-container >> nth=1')
    .click({ button: 'right' })
  ...
  expect(
    await page.locator('.ls-block .block-content >> nth=1').innerHTML()
  ).toContain('<h3>bar</h3>')
})

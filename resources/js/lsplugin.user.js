  ...
  (() => {
          ...
          e.exports = (function () {
            ...
            function re() {
              ...
              var de,
                ...
                xe = Y,
                Ce = null,
                Se = F({}, [].concat(o(P), o(R), o(D), o($), o(H))),
                Oe = null,
                je = F({}, [].concat(o(B), o(q), o(W), o(G))),
                Ae = Object.seal(
                  Object.create(null, {
                    tagNameCheck: {
                      writable: !0,
                ...
                st = function (t) {
                  ;(rt && rt === t) ||
                    ((t && 'object' === e(t)) || (t = {}),
                    (t = L(t)),
                    (Ce = 'ALLOWED_TAGS' in t ? F({}, t.ALLOWED_TAGS) : Se),
                    (Oe = 'ALLOWED_ATTR' in t ? F({}, t.ALLOWED_ATTR) : je),
                    (Ze =
                      'ADD_URI_SAFE_ATTR' in t
                        ? F(L(Ve), t.ADD_URI_SAFE_ATTR)
                        : Ve),
                    (Ge =
                      'ADD_DATA_URI_TAGS' in t
                        ? F(L(Je), t.ADD_DATA_URI_TAGS)
                        : Je),
                    (qe =
                      'FORBID_CONTENTS' in t ? F({}, t.FORBID_CONTENTS) : We),
                    (Ee = 'FORBID_TAGS' in t ? F({}, t.FORBID_TAGS) : {}),
                    (ke = 'FORBID_ATTR' in t ? F({}, t.FORBID_ATTR) : {}),
                    (Be = 'USE_PROFILES' in t && t.USE_PROFILES),
                    ...
                    Be &&
                      ((Ce = F({}, o(H))),
                      (Oe = []),
                      !0 === Be.html && (F(Ce, P), F(Oe, B)),
                      !0 === Be.svg && (F(Ce, R), F(Oe, q), F(Oe, G)),
                      !0 === Be.svgFilters && (F(Ce, D), F(Oe, q), F(Oe, G)),
                      !0 === Be.mathMl && (F(Ce, $), F(Oe, W), F(Oe, G))),
                    t.ADD_TAGS &&
                      (Ce === Se && (Ce = L(Ce)), F(Ce, t.ADD_TAGS)),
                    t.ADD_ATTR &&
                      (Oe === je && (Oe = L(Oe)), F(Oe, t.ADD_ATTR)),
                    t.ADD_URI_SAFE_ATTR && F(Ze, t.ADD_URI_SAFE_ATTR),
                    t.FORBID_CONTENTS &&
                      (qe === We && (qe = L(qe)), F(qe, t.FORBID_CONTENTS)),
                    ze && (Ce['#text'] = !0),
                    Le && F(Ce, ['html', 'head', 'body']),
                    Ce.table && (F(Ce, ['tbody']), delete Ee.tbody),
                    m && m(t),
                    (rt = t))
                },
                ...
                lt = F({}, ['title', 'style', 'font', 'a', 'script']),
                ut = F({}, R)
              ;(F(ut, D), F(ut, U))
              var ft = F({}, $)
              F(ft, z)
              var pt = function (e) {
                ...
                _t = function (e) {
                  ...
                  if (
                    ...
                    e.hasChildNodes() &&
                      ...
                      (!vt(e.content) || !vt(e.content.firstElementChild)) &&
                      k(/<[/\w]/g, e.innerHTML) &&
                      k(/<[/\w]/g, e.textContent))
                  )
                    return (ht(e), !0)
                  ...
                  if (!Ce[r] || Ee[r]) {
                    ...
                    if (ze && !qe[r]) {
                      var o = I(e) || e.parentNode,
                        i = _(e) || e.childNodes
                      if (i && o)
                        for (var s = i.length - 1; s >= 0; --s)
                          o.insertBefore(v(i[s], !0), b(e))
                    }
                    return (ht(e), !0)
                  }
                  return e instanceof l && !pt(e)
                    ? (ht(e), !0)
                    : ('noscript' !== r && 'noembed' !== r) ||
                      ...
                      ? (Fe &&
                          ...
                          (t = j(t, ye, ' ')),
                          e.textContent !== t &&
                            (C(n.removed, { element: e.cloneNode() }),
                            (e.textContent = t))),
                ...
                wt = function (e, t, n) {
                  if ($e && ('id' === t || 'name' === t) && (n in i || n in ot))
                    return !1
                  if (Ie && !ke[t] && k(ve, t));
                  else if (Te && k(be, t));
                  else if (!Oe[t] || ke[t]) {
                  ...
                  if (s) {
                    ...
                    for (i = s.length; i--;) {
                      ...
                      if (
                        ...
                        (r = a.attrValue),
                        !a.forceKeepAttr && (dt(l, e), a.keepAttr))
                      )
                        if (k(/\/>/i, r)) dt(l, e)
                        else {
                ...
                St = function e(t) {
                  ...
                  for (
                    ...
                    (bt('uponSanitizeShadowNode', n, null),
                      _t(n) || (n.content instanceof s && e(n.content), Ct(n)))
              ...
              return (
                (n.sanitize = function (o, i) {
                  ...
                  if (
                    ...
                    if (!Re && !Fe && !Le && -1 === o.indexOf('<'))
                      return oe && Ue ? oe.createHTML(o) : o
                    if (!(a = mt(o))) return Re ? null : Ue ? ie : ''
                  }
                  a && Pe && ht(a.firstChild)
                  for (var d = gt(He ? o : a); (u = d.nextNode());)
                    (3 === u.nodeType && u === f) ||
                      _t(u) ||
                      (u.content instanceof s && St(u.content), Ct(u), (f = u))
                  if (((f = null), He)) return o
                  if (Re) {
                    if (De)
                      for (p = le.call(a.ownerDocument); a.firstChild;)
                  ...
                  return (
                    Le &&
                      ...
                      k(ee, a.ownerDocument.doctype.name) &&
                      (m =
                        '<!DOCTYPE ' +
                        a.ownerDocument.doctype.name +
                        '>\n' +
                        m),
                    Fe && ((m = j(m, ge, ' ')), (m = j(m, ye, ' '))),
        ...
        729: (e) => {
          ...
          ;(Object.create &&
            ...
            (a.prototype.emit = function (e, t, r, o, i, s) {
              ...
              if (u.fn) {
                switch (
                  (u.once && this.removeListener(e, u.fn, void 0, !0), f)
                ) {
                  case 1:
    ...
    return (
      (() => {
        'use strict'
        ;(n.r(r),
          n.d(r, { LSPluginUser: () => Nr, setupPluginUserInstance: () => Pr }))
        var e = n(520),
          t = (n(856), n(996)),
          o = n.n(t)
        var i = function () {
        ...
        const d =
          'win32' === navigator.platform.toLowerCase() ? e.win32 : e.posix
        const m = function (e, t) {
          return (void 0 === t && (t = {}), u(e, i({ delimiter: '_' }, t)))
        }
        class g extends p() {
          constructor(e, t) {
            ;(super(),
        ...
        class A {
          constructor(e) {
            ;(x(this, 'parent', void 0),
              x(this, 'frame', void 0),
              x(this, 'child', void 0),
              x(this, 'events', {}),
              x(this, 'childOrigin', void 0),
              x(this, 'listener', void 0),
              ...
              const o = ++S,
                i = (e) => {
                  e.data.uid === o &&
                    ...
                    (this.parent.removeEventListener('message', i, !1),
          ...
          call(e, t) {
            this.child.postMessage(
              { postmate: 'call', type: C, property: e, data: t },
              this.childOrigin
            )
          }
          on(e, t) {
        ...
        class E {
          ...
          emit(e, t) {
            this.parent.postMessage(
              { postmate: 'emit', type: C, value: { name: e, data: t } },
              this.parentOrigin
            )
          }
        }
          ...
          sendHandshake(e) {
            ...
            return new Promise((o, i) => {
              ...
              const a = () => {
                ;(r++,
                  this.child.postMessage(
                    { postmate: 'handshake', type: C, model: this.model },
                    t
                  ),
                  5 === r && clearInterval(n))
              }
        ...
        const { importHTML: M, createSandboxContainer: F } =
          window.QSandbox || {}
        function L(e, t) {
        ...
        class N extends p() {
          constructor(e) {
            ;(super(),
              I(this, '_pluginLocal', void 0),
              I(this, '_frame', void 0),
              I(this, '_root', void 0),
              I(this, '_loaded', !1),
              I(this, '_unmountFns', []),
              (this._pluginLocal = e),
          ...
          async load() {
            ...
            const { template: n, execScripts: r } = await M(t, { fetch: L })
            this._mount(n, document.body)
            const o = F(e, {
              elementGetter: () => {
                var e
                return null === (e = this._root) || void 0 === e
                  ? void 0
                  : e.firstChild
              },
            }).instance.proxy
            ;((o.__shadow_mode__ = !0),
              ...
              (o.LSPluginUser = o.logseq =
                new Nr(this._pluginLocal.toJSON(), this._pluginLocal.caller)))
            const i = await r(o, !0)
        ...
        class H extends p() {
          constructor(e) {
            ;(super(),
              P(this, '_pluginLocal', void 0),
              P(this, '_connected', !1),
              P(this, '_parent', void 0),
              P(this, '_child', void 0),
              P(this, '_shadow', void 0),
              P(this, '_status', void 0),
              P(this, '_userModel', {}),
              P(this, '_call', void 0),
              P(this, '_callUserModel', void 0),
              P(this, '_debugTag', ''),
              (this._pluginLocal = e),
            ...
            const i = new Map(),
              ...
              a = this._extendUserModel({
                '#lspmsg#ready#': async (e) => {
                  ;((a[z(null == e ? void 0 : e.pid)] = ({
                    type: e,
                    payload: n,
                  }) => {
                    ;(R(`[host (_call) -> *user] ${this._debugTag}`, e, n),
                      t.emit(e, n))
                  }),
                    await s.resolve())
                },
                ...
                .then((e) => {
                  ;((this._child = e),
                    ...
                    (this._call = async (t, n = {}, r) => {
                      ...
                      return (
                        e.emit(z(a.baseInfo.id), { type: t, payload: n }),
                  ...
                  l
                    .then((n) => {
                      ;((this._parent = n),
                        ...
                        (this._callUserModel = async (e, ...t) => {
                          if (e.startsWith(D))
                            return await n.get(e.replace(D, ''), ...t)
                ...
                (this._call = async (t, n = {}, r) => {
                  ...
                  return (
                    ...
                    null === (o = this._pluginLocal) ||
                      void 0 === o ||
                      o.emit(t, Object.assign(n, { $$pid: e.id })),
                    null == r ? void 0 : r.promise
                  )
                }),
          ...
          _getSandboxIframeContainer() {
            var e
            return null === (e = this._parent) || void 0 === e
              ? void 0
              : e.frame.parentNode
          }
          _getSandboxShadowContainer() {
            var e
            return null === (e = this._shadow) || void 0 === e
              ? void 0
              : e.frame.parentNode
          }
          ...
          async destroy() {
            ...
            ;(this._parent &&
              ...
              null === (e = t) || void 0 === e || e.parentNode.removeChild(t))
          }
        }
        function B(e, t, n) {
          return (
        ...
        class W {
          ...
          invokeExperMethod(e, ...t) {
            ...
            return (
              (e =
                null === (n = m(e)) || void 0 === n ? void 0 : n.toLowerCase()),
              null === (r = o.logseq.api['exper_' + e]) || void 0 === r
                ? void 0
                : r.apply(o, t)
            )
          }
          async loadScripts(...e) {
            ;((e = e.map((e) =>
              null != e && e.startsWith('http')
                ? e
                : this.ctx.resolveResourceFullUrl(e)
        ...
        class Z {
          constructor(e, t, n = {}) {
            ;(G(this, '_client', void 0),
              G(this, '_requestId', void 0),
              G(this, '_requestOptions', void 0),
        ...
        class V extends f.EventEmitter {
          ...
          async _request(e) {
            const t = this.ctx.baseInfo.id,
              ...
              a = V.createRequestTask(this.ctx.Request, s, e)
        ...
        var he,
          de = (he = /[^.]+$/.exec((pe && pe.keys && pe.keys.IE_PROTO) || ''))
            ? 'Symbol(src)_1.' + he
            : ''
        const me = function (e) {
          return !!de && de in e
        ...
        var De =
          ...
          Ue =
            ...
            !module.nodeType &&
            module,
          $e = Ue && Ue.exports === De ? X.Buffer : void 0
        ...
        const Mt = function (e, t) {
          ...
          return (
            ...
            (n[e] = Ot && void 0 === t ? '__lodash_hash_undefined__' : t),
            this
          )
        }
        function Ft(e) {
        ...
        ;((Ht.prototype.clear = Nt),
          (Ht.prototype.delete = Dt),
          (Ht.prototype.get = Ut),
          (Ht.prototype.has = $t),
          (Ht.prototype.set = zt))
        const Bt = Ht
        ...
        var wn = '[object Map]',
          ...
          Tn = ye(_n),
          In = le
        ;((yn && In(new yn(new ArrayBuffer(1))) != On) ||
          (St && In(new St()) != wn) ||
          (vn && In(vn.resolve()) != xn) ||
          (bn && In(new bn()) != Cn) ||
          (_n && In(new _n()) != Sn)) &&
        ...
        const Rn = function (e, t, n, r, o, i) {
          ...
          if (p && !u)
            return (
              i || (i = new Gt()),
              s || Xe(e) ? Xt(e, t, n, r, o, i) : sn(e, t, c, n, r, o, i)
            )
          if (!(1 & n)) {
            var h = u && Pn.call(e, '__wrapped__'),
          ...
          constructor(e, t) {
            ...
            Object.entries({
              query: {
                ...
                reply: !0,
                transformOutput: (e) => (
                  K(null == e ? void 0 : e.blocks) &&
                    (e.blocks = e.blocks.map(
                      (e) => e && yr(e, (e, t) => `block/${t}`)
                    )),
                  e
                ),
              },
        ...
        const wr = Symbol.for('proxy-continue'),
          xr = w()('LSPlugin:user'),
          Cr = new g('', { console: !0 })
        function Sr(e, t, n) {
          var r
          ...
          if ('function' != typeof n)
            return (
              this.logger.error(
                `${o || i}: command action should be function.`
              ),
              !1
            )
          const u = (function (e) {
        ...
        function Or(e) {
          return (
            ...
            ) || (Cr.error(`#${e} is not a valid UUID string.`), !1)
          )
          var t
        }
        let jr = null,
        ...
        const Er = {
          async getInfo(e) {
            return (
              jr || (jr = await this._execCallableAPIAsync('get-app-info')),
              'string' == typeof e ? jr[e] : jr
            )
          },
          registerCommand: Sr,
          ...
          registerCommandShortcut(e, t, n = {}) {
            ...
            const { binding: r } = e,
              o = '$shortcut$',
              i = n.key || o + m(null == r ? void 0 : r.toString())
            return Sr.call(
              this,
              o,
              { ...n, key: i, palette: !1, keybinding: e },
              t
            )
          },
          registerUIItem(e, t) {
          ...
          registerPageMenuItem(e, t) {
            ...
            const n = e + '_' + this.baseInfo.id,
              r = e
            Sr.call(this, 'page-menu-item', { key: n, label: r }, t)
          },
          onBlockRendererSlotted(e, t) {
            if (!Or(e)) return
            const n = this.baseInfo.id,
              r = `hook:editor:${m(`slot:${e}`)}`
            return (
              this.caller.on(r, t),
          ...
          invokeExternalPlugin(e, ...t) {
            var n
            if (!(e = null === (n = e) || void 0 === n ? void 0 : n.trim()))
              return
            let [r, o] = e.split('.')
            if (
        ...
        const Tr = {
            ...
            registerSlashCommand(e, t) {
              var n
              ;(xr('Register slash command #', this.baseInfo.id, e, t),
                'function' == typeof t &&
                  (t = [
            ...
            registerBlockContextMenuItem(e, t) {
              if ('function' != typeof t) return !1
              const n = e + '_' + this.baseInfo.id
              Sr.call(this, 'block-context-menu-item', { key: n, label: e }, t)
            },
          ...
          Ir = {
            ...
            datascriptQuery(e, ...t) {
              if (
                (t.pop(), null != t && t.some((e) => 'function' == typeof e))
              ) {
          ...
          Lr = {
            makeSandboxStorage() {
              return new q(this, { assets: !0 })
            },
          }
        class Nr extends p() {
          constructor(e, t) {
            ;(super(),
              _r(this, '_baseInfo', void 0),
              _r(this, '_caller', void 0),
              _r(this, '_version', '0.0.16'),
              _r(this, '_debugTag', ''),
              _r(this, '_settingsSchema', void 0),
              _r(this, '_connected', !1),
              _r(this, '_ui', new Map()),
              _r(this, '_mFileStorage', void 0),
              _r(this, '_mRequest', void 0),
              _r(this, '_mExperiments', void 0),
              _r(this, '_beforeunloadCallback', void 0),
              (this._baseInfo = e),
              (this._caller = t),
              ...
              try {
                ...
                ;((this._connected = !0),
                  ...
                  this._settingsSchema &&
                    ((s.settings = (function (e, t) {
                      const n = (t || []).reduce(
                        (e, t) => ('default' in t && (e[t.key] = t.default), e),
                        {}
                      )
                      return Object.assign(n, e)
                    })(s.settings, this._settingsSchema)),
          ...
          get effect() {
            return (
              ...
              ((null === (t = e.baseInfo) || void 0 === t
                ? void 0
                : t.effect) ||
                !(null !== (n = e.baseInfo) && void 0 !== n && n.iir))
            )
            var e, t, n
          }
          get logger() {
          ...
          get settings() {
            var e
            return null === (e = this.baseInfo) || void 0 === e
              ? void 0
              : e.settings
          }
          get caller() {
          ...
          resolveResourceFullUrl(e) {
            if ((this.ensureConnected(), e))
              return ((e = e.replace(/^[.\\/]+/, '')), y(this._baseInfo.lsr, e))
          }
          _makeUserProxy(e, t) {
            const n = this,
              r = this.caller
                ...
                return function (...e) {
                  ...
                  if (t) {
                    ...
                    if (null != i) {
                      ...
                      return a
                        ? void p()
                        : (n.App._installPluginHook(c, l, f), p)
                    }
                  }
                  let i = o
                  return (

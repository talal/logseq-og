...
- لاگ‌سیک یک سکوی [آزاد](https://github.com/talal/logseq-og) برای مدیریت _دانش_ و همکاری است که _حریم شخصی_ را در اولویت اول قرار می‌دهد.
...
- همچنین می‌توانید برنامهٔ میزکار را از این نشانی دریافت کنید: https://github.com/talal/logseq-og/releases

## こんにちは、Logseq へようこそ！
- Logseq はプライバシーファーストで知識管理とコラボレーションを実現する[オープンソース](https://github.com/talal/logseq-og)プラットフォームです。
...
- デスクトップアプリのダウンロードはこちらから： https://github.com/talal/logseq-og/releases

...
(deftest extract-nearest-link-from-text-test
  ...
  (testing "Url links"
    (is (= "https://github.com/talal/logseq-og"
           (editor/extract-nearest-link-from-text
            "https://github.com/talal/logseq-og is #awesome :)" 0 editor/url-regex))
        "Finds url correctly")

    (is (not= "https://github.com/talal/logseq-og"
              (editor/extract-nearest-link-from-text
               "https://github.com/talal/logseq-og is #awesome :)" 0))
        "Doesn't find url if regex not passed")

    (is (= "https://github.com/talal/logseq-og"
           (editor/extract-nearest-link-from-text
            "[logseq](https://github.com/talal/logseq-og) is #awesome :)" 0 editor/url-regex))
        "Finds url in markdown link correctly"))

  (is (= "https://github.com/talal/logseq-og"
         (editor/extract-nearest-link-from-text
          "[[https://github.com/talal/logseq-og][logseq]] is #awesome :)" 0 editor/url-regex))
